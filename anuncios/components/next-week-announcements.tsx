...
const announcements = [
  {
    ...
    companions: ["Hna. Ruth Sarango", "Hno. Fernando Sarango"],
    personLabel: "Predica",
    verse:
  ...
  },
  {
    ...
    persons: ["Hno. Franco Soto", "Hno. Oscar SantaCruz"],
  ...
  },
  {
    ...
    persons: ["Hno. Daniel Menida", "Hno. Camila Coperan"],
