...
const announcements = [
  {
    ...
    person: "Hno. Hernan Vega",
    companions: ["Hno.Jose Jumbo", "Hno.Carolina Sarango"],
    personLabel: "Predica",
    verse:
  ...
  },
  {
    ...
    persons: ["Fam. Ronquillo Jaramillo"],
  ...
  },
  {
    ...
    persons: ["Hna. Andrea Lituma", "Hna. Lady Vascones"],
