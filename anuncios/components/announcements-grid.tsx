...
const announcements = [
  {
    ...
    person: "hna. Norka Choque",
    companions: ["Hna. Graciela Tacuri", "Hna. Rebeca Ordoñes"],
    personLabel: "Predica",
    verse:
  ...
  },
  {
    ...
    persons: ["Hno. Elias Jaramillo", "Hno. Emanuel Jaramillo"],
    personLabel: "Nos ayudan l@s herman@s",
  ...
  },
  {
    ...
    person: "Hno. Christopher Jaramillo",
    personLabel: "Nos ayuda herman@",
