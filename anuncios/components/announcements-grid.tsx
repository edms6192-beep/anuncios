...
const announcements = [
  {
    ...
    companions: ["Hna. Ruth Sarango", "Hno. Eddy Calva"],
    personLabel: "Predica",
    verse:
  ...
  },
  {
    ...
    persons: ["Hno. Carlos Sarango", "Hna. Eunice Medina"],
