...
const announcements = [
  {
    ...
    person: "Hna. Monica Medina",
    companions: ["Hna. Rosa Medina", "Hna. Rebeca Ordoñes"],
    personLabel: "Predica",
    verse:
  ...
  },
  {
    ...
    persons: ["Hna. Ideli Jumbo", "Hna. Nancy Tandazo"],
    personLabel: "Nos ayudan l@s herman@s",
  ...
  },
  {
    ...
    person: "Hno. Esteban Villavicencio",
    personLabel: "Nos ayuda herman@",
