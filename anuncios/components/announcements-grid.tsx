...
const announcements = [
  {
    ...
    person: "Hna. Cristina Crespo",
    companions: ["Hna. Diana Contento", "Hna. Jhony Medina"],
    personLabel: "Predica",
    verse:
  ...
  },
  {
    ...
    persons: ["Hna. Julia Alulima", "Hno. Victor Carreño"],
  ...
  },
  {
    ...
    person: ["Hna. Gloria Huratdo", "Hna. Linda Espinoza"],
  ...
  },
  {
    ...
    persons: ["Hno. Pablo Cosios", "Hno. Julio Quituizaca"],
    personLabel: "Nos ayudan l@s herman@s",
...
export function AnnouncementsGrid() {
  ...
  const handleCopyToWhatsApp = () => {
    let textToCopy = "📋 *RESUMEN DE PRIVILEGIOS - ESTA SEMANA* 📋\n\n";
            ...
            >
              ...
              <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-12 pb-8 border-b border-[#E3D5C1] gap-6">
                <div>
                  ...
                  <p className="text-stone-500 mt-4 tracking-wide">Esta semana</p>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
                {announcements.map((item) => (
                  <div key={`summary-${item.id}`} className="group flex items-start gap-4 p-4 rounded-xl hover:bg-white/50 transition-colors border border-transparent hover:border-[#E3D5C1]">
